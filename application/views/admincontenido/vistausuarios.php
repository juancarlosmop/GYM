...
<div class="row">
<table id="tbusuarios" class="table table-bordered">
              <thead>
                <tr>
                 <th>Clave</th>
                  <th>Nombre</th>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form action="<?php echo base_url();?>usuario_controller/generarpdf" method="POST" id="f">
...
<!-- Modal para ver cantidad de asistencias en el mes -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form action="<?php echo base_url()?>usuario_controller/totalasis" method="POST">
          ...
          <input type="hidden" name="tpf" value="us">
          <div class="container">
            <div class="row">
...
<?php } ?>           
<script src="<?php  echo base_url();?>assets/js/lsusuarios.js">
</script>
